...
simulacion = run_swat2012(project_path = "C:/SWAT/Drive/SWAT_mensual/Backup/",
                          start_date = "2006-01-01",
                          end_date = "2015-12-31",
                          years_skip = 4,
                          ...
                          output_interval = "m",
                          parameter = par_set[1:3,],
                          keep_folder = FALSE,
                          n_thread = 4,
                          save_path = "C:/SWAT/Drive/SWAT_mensual/out_mensual/2da_optim/")


save.image("C:/SWAT/Corridas_3sim.RData")